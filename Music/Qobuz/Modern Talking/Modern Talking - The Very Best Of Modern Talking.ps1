...
ffmpeg -ss 00:00:00.300 -to 00:03:44.000 -i "2-Cheri Cheri Lady.flac" -map_metadata -1 -map 0:0 -metadata artist="Modern Talking" -metadata album_artist="Modern Talking" -metadata album="The Very Best Of Modern Talking" -metadata date="2001-01-01" -metadata genre="Pop" -metadata track="2/32" -metadata title="Cheri Cheri Lady" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "02 - Cheri Cheri Lady.ogg"
Move-Item -Path "02 - Cheri Cheri Lady.ogg" -Destination "Modern Talking/The Very Best Of Modern Talking (Converted)"
