...
ffmpeg -i "01 - Cut the Cord.mp3" -map_metadata -1 -map 0:0 -metadata artist="The Living Tombstone / EileMonty" -metadata album_artist="The Living Tombstone" -metadata album="Cut the Cord [Single]" -metadata date="2017-02-01" -metadata genre="Electronic | Pop" -metadata title="Cut the Cord" -c:a libvorbis -q 5 -minrate 128k "Cut the Cord.ogg"
...
ffmpeg -i "01 - Hit The Snooze [Explicit].mp3" -map_metadata -1 -map 0:0 -metadata artist="The Living Tombstone" -metadata album_artist="The Living Tombstone" -metadata album="Hit The Snooze [Single]" -metadata date="2022-03-11" -metadata genre="Electronic | Pop" -metadata title="Hit The Snooze" -c:a libvorbis -q 5 -minrate 128k "Hit The Snooze.ogg"
...
ffmpeg -i "01 - Love I Need.mp3" -map_metadata -1 -map 0:0 -metadata artist="The Living Tombstone" -metadata album_artist="The Living Tombstone" -metadata album="Love I Need [Single]" -metadata date="2020-08-06" -metadata genre="Techno | Pop" -metadata title="Love I Need" -c:a libvorbis -q 5 -minrate 128k "Love I Need.ogg"
