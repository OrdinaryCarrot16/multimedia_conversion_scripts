...
ffmpeg -i "01 - Every Door.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Every Door [Single]" -metadata date="2018-09-15" -metadata genre="Pop" -metadata title="Every Door" -c:a libvorbis -q 5 -minrate 128k "Every Door.ogg"
...
ffmpeg -i "01 - Labyrinth.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Labyrinth [Single]" -metadata date="2017-12-16" -metadata genre="Pop" -metadata title="Labyrinth" -c:a libvorbis -q 5 -minrate 128k "Labyrinth.ogg"
...
ffmpeg -i "01 - Make Your Move.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Make Your Move [Single]" -metadata date="2018-11-23" -metadata genre="Pop" -metadata title="Make Your Move" -c:a libvorbis -q 5 -minrate 128k "Make Your Move.ogg"
