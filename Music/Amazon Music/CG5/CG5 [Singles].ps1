...
ffmpeg -i "01 - Every Door.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5 / Caleb Hyles" -metadata album_artist="CG5" -metadata album="Every Door [Single]" -metadata date="2018-09-15" -metadata genre="Pop" -metadata title="Every Door" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Every Door.ogg"
...
ffmpeg -i "01 - Father’s Day.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Father's Day [Single]" -metadata date="2020-06-19" -metadata genre="Pop" -metadata title="Father's Day" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Father's Day.ogg"
...
ffmpeg -i "01 - Fish Out of Water (Amazing) [feat. Charlie Green].mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Fish Out of Water [Single]" -metadata date="2017-03-27" -metadata genre="Pop" -metadata title="Fish Out of Water" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Fish Out of Water.ogg"
...
ffmpeg -i "01 - Good to Be Alive.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Good to Be Alive [Single]" -metadata date="2021-02-03" -metadata genre="Pop" -metadata title="Good to Be Alive" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Good to Be Alive.ogg"
...
ffmpeg -i "01 - I See a Dreamer.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="I See A Dreamer [Single]" -metadata date="2021-01-13" -metadata genre="Pop" -metadata title="I See A Dreamer" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "I See A Dreamer.ogg"
...
ffmpeg -i "01 - Labyrinth.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5 / Caleb Hyles / Chi-Chi / DA-Games / Dawko / Fandroid Music" -metadata album_artist="CG5" -metadata album="Labyrinth [Single]" -metadata date="2017-12-16" -metadata genre="Pop" -metadata title="Labyrinth" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Labyrinth.ogg"
...
ffmpeg -i "01 - Lyin' 2 Me.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Lyin`' 2 Me [Single]" -metadata date="2020-11-18" -metadata genre="Pop" -metadata title="Lyin`' 2 Me" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Lying To Me.ogg"
...
ffmpeg -i "01 - Make Your Move.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5 / Dawko" -metadata album_artist="CG5" -metadata album="Make Your Move [Single]" -metadata date="2018-11-23" -metadata genre="Pop" -metadata title="Make Your Move" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Make Your Move.ogg"
...
ffmpeg -i "01 - Show Yourself.mp3" -map_metadata -1 -map 0:0 -metadata artist="CG5" -metadata album_artist="CG5" -metadata album="Show Yourself [Single]" -metadata date="2020-09-15" -metadata genre="Pop" -metadata title="Show Yourself" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Show Yourself.ogg"
