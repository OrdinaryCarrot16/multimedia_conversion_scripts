...
ffmpeg -i "01 - Count to Three.mp3" -map_metadata -1 -map 0:0 -metadata artist="The Chalk-Eaters / Ellen McLain / Gabe Newell / The Stupendium" -metadata album_artist="The Chalk-Eaters" -metadata album="Count To Three [Single]" -metadata date="2021-03-29" -metadata genre="Pop" -metadata title="Count To Three" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "Count To Three.ogg"
...
ffmpeg -i "01 - It Just Works.mp3" -map_metadata -1 -map 0:0 -metadata artist="The Chalk-Eaters / Kyle Wright" -metadata album_artist="The Chalk-Eaters" -metadata album="It Just Works [Single]" -metadata date="2019-06-11" -metadata genre="Pop" -metadata title="It Just Works" -af "volume=-10dB" -c:a libvorbis -q 5 -minrate 128k "It Just Works.ogg"
