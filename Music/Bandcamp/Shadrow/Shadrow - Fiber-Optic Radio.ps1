...
Move-Item -Path "Re-Boot (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Shadrow - Dr. Gaster.png" -an -vf scale=1024:1024 -sws_flags bicubic "Dr. Gaster (thumb).png"
Move-Item -Path "Dr. Gaster (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Estrill - Never Be Alone.png" -an -vf scale=1024:1024 -sws_flags bicubic "Never Be Alone (thumb).png"
Move-Item -Path "Never Be Alone (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Shadrow - Blips and Chitz.png" -an -vf scale=1024:1024 -sws_flags bicubic "Blips And Chitz (thumb).png"
Move-Item -Path "Blips And Chitz (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Addi Wallace - Defrag.png" -an -vf scale=1024:1024 -sws_flags bicubic "Defrag (thumb).png"
Move-Item -Path "Defrag (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Estrill - Monster Kid.png" -an -vf scale=1024:1024 -sws_flags bicubic "Monster Kid (thumb).png"
Move-Item -Path "Monster Kid (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Addi Wallace - Quiet Country Town.png" -an -vf scale=1024:1024 -sws_flags bicubic "Quiet Country Town (thumb).png"
Move-Item -Path "Quiet Country Town (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Rough Draft - Bottlenecked.png" -an -vf scale=1024:1024 -sws_flags bicubic "Bottle-Necked (thumb).png"
Move-Item -Path "Bottle-Necked (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Danny - Mach Speed Mania.png" -an -vf scale=1024:1024 -sws_flags bicubic "Mach-Speed Mania (thumb).png"
Move-Item -Path "Mach-Speed Mania (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Estrill - Deep Inside.png" -an -vf scale=1024:1024 -sws_flags bicubic "Deep Inside (thumb).png"
Move-Item -Path "Deep Inside (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Addi Wallace - Spider Girl.png" -an -vf scale=1024:1024 -sws_flags bicubic "Spider Girl (thumb).png"
Move-Item -Path "Spider Girl (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Estrill - Mr Superliminal.png" -an -vf scale=1024:1024 -sws_flags bicubic "Mr. Super-Liminal (thumb).png"
Move-Item -Path "Mr. Super-Liminal (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -i "Shadrow - Fiber-Optic Radio - Art - Avex - Log Off.png" -an -vf scale=1024:1024 -sws_flags bicubic "Log-Off (thumb).png"
Move-Item -Path "Log-Off (thumb).png" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
