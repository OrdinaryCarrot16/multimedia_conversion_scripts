...
ffmpeg -ss 00:00:00.000 -to 00:03:55.700 -i "Shadrow - Fiber-Optic Radio - 02 Dr. Gaster.flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune" -metadata track="2/24" -metadata title="Dr. Gaster" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "02 - Dr. Gaster.ogg"
Move-Item -Path "02 - Dr. Gaster.ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -ss 00:00:00.000 -to 00:02:57.850 -i "Shadrow - Fiber-Optic Radio - 03 Never Be Alone.flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune" -metadata track="3/24" -metadata title="Never Be Alone" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "03 - Never Be Alone.ogg"
Move-Item -Path "03 - Never Be Alone.ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -ss 00:00:00.000 -to 00:02:41.900 -i "Shadrow - Fiber-Optic Radio - 04 Blips and Chitz.flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune" -metadata track="4/24" -metadata title="Blips & Chitz" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "04 - Blips And Chitz.ogg"
Move-Item -Path "04 - Blips And Chitz.ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -ss 00:00:00.000 -to 00:04:16.600 -i "Shadrow - Fiber-Optic Radio - 05 Defrag.flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune" -metadata track="5/24" -metadata title="Defrag" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "05 - Defrag.ogg"
Move-Item -Path "05 - Defrag.ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -ss 00:00:00.000 -to 00:04:03.800 -i "Shadrow - Fiber-Optic Radio - 06 Monster Kid.flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune" -metadata track="6/24" -metadata title="Monster Kid" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "06 - Monster Kid.ogg"
Move-Item -Path "06 - Monster Kid.ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -ss 00:00:00.000 -to 00:03:20.500 -i "Shadrow - Fiber-Optic Radio - 07 Quiet Country Town.flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune" -metadata track="7/24" -metadata title="Quiet Country Town" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "07 - Quiet Country Town.ogg"
Move-Item -Path "07 - Quiet Country Town.ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
...
ffmpeg -ss 00:00:00.000 -to 00:02:15.750 -i "Shadrow - Fiber-Optic Radio - 09 Mach Speed Mania.flac" -map_metadata -1 -map 0:0 -metadata artist="Shadrow" -metadata album_artist="Shadrow" -metadata album="Fiber-Optic Radio" -metadata date="2017-04-28" -metadata genre="Electronic | Chiptune" -metadata track="9/24" -metadata title="Mach-Speed Mania" -af "apad=pad_dur=3s,volume=-5dB" -c:a libvorbis -q 6 -minrate 128k "09 - Mach-Speed Mania.ogg"
Move-Item -Path "09 - Mach-Speed Mania.ogg" -Destination "Shadrow/Fiber-Optic Radio (Converted)"
