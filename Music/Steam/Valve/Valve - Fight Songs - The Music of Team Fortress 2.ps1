...
New-Item -Path "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]" -ItemType Directory


ffmpeg -i "cover.jpg" -an -vf scale=512:512 -sws_flags bicubic thumb.png
Move-Item -Path "thumb.png" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"


ffmpeg -i "01 - Medic!.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="1/32" -metadata title="Medic!" -c:a libvorbis -q 5 -minrate 128k "Medic.ogg"
Move-Item -Path "Medic.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"

ffmpeg -i "02 - Intruder Alert.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="2/32" -metadata title="Intruder Alert" -c:a libvorbis -q 5 -minrate 128k "Intruder Alert.ogg"
Move-Item -Path "Intruder Alert.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"

ffmpeg -i "03 - The Calm.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="3/32" -metadata title="The Calm" -c:a libvorbis -q 5 -minrate 128k "The Calm.ogg"
Move-Item -Path "The Calm.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Dapper Cadaver.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Dreams of Cruelty.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "A Little Heart to Heart.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "RED Triumphs.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Faster Than a Speeding Bullet.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "It Hates Me So Much.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Rocket Jump Waltz.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Drunken Pipe Bomb.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Three Days to Live.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Misfortune Teller.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Archimedes.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Soldier Of Dance.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Playing With Danger.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Haunted Fortress.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Rise of the Living Bread.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"

ffmpeg -i "19 - Robots!.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="19/32" -metadata title="Robots!" -c:a libvorbis -q 5 -minrate 128k "Robots.ogg"
Move-Item -Path "Robots.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "The Art of War.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Petite Chou-Fleur.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"

ffmpeg -i "22 - Seduce Me!.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="22/32" -metadata title="Seduce Me!" -c:a libvorbis -q 5 -minrate 128k "Seduce Me.ogg"
Move-Item -Path "Seduce Me.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"

ffmpeg -i "23 - More Gun.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="23/32" -metadata title="More Gun" -c:a libvorbis -q 5 -minrate 128k "More Gun.ogg"
Move-Item -Path "More Gun.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "BLU Triumphs.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Stink Lines.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Right Behind You.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"

ffmpeg -i "27 - Red Bread.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="27/32" -metadata title="Red Bread" -c:a libvorbis -q 5 -minrate 128k "Red Bread.ogg"
Move-Item -Path "Red Bread.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Team Fortress 2.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Carousel Of Curses.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"

ffmpeg -i "30 - Yeti Park.flac" -map_metadata -1 -map 0:0 -metadata artist="Valve" -metadata album_artist="Valve" -metadata album="Fight Songs: The Music of Team Fortress 2" -metadata date="2017-05-04" -metadata genre="Sound-Track" -metadata track="30/32" -metadata title="Yeti Park" -c:a libvorbis -q 5 -minrate 128k "Yeti Park.ogg"
Move-Item -Path "Yeti Park.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Saxtons Dilemma.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
...
Move-Item -Path "Mercenary Park.ogg" -Destination "Valve/Fight Songs - The Music of Team Fortress 2 [Converted]"
