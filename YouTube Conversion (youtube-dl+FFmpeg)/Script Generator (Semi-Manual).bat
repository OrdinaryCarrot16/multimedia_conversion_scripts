...
set /A TRACK_COUNTER=0+1
set /P channel=YouTube Channel Name: 
set /P language=Language: 
set /P media_type=Is it a movie/single video or a TV show/series (type 'movie' or 'tv' depending on what the content is): 
