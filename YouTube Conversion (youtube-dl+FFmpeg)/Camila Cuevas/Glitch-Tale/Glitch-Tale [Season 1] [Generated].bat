...
ffmpeg -i "Yet Darker - Undertale Animation (Glitchtale #2) [l4tGTxbnujY].mp4" -map_metadata -1 -map_chapters -1 -map 0:0 -map 0:1 -id3v2_version 3 -metadata artist="Camila Cuevas" -metadata show="Glitch-Tale" -metadata title="Yet Darker" -metadata track="2/5" -metadata genre="" -metadata language="English" -metadata encoder="FFmpeg (libx264 + aac)" -threads 2 -c:a copy -c:v copy -movflags +faststart "Yet Darker.mp4"  
...
ffmpeg -i "Determination. - Undertale Animation (Glitchtale #3) [F-iO-I0oGn8].mp4" -map_metadata -1 -map_chapters -1 -map 0:0 -map 0:1 -id3v2_version 3 -metadata artist="Camila Cuevas" -metadata show="Glitch-Tale" -metadata title="Determination." -metadata track="3/5" -metadata genre="" -metadata language="English" -metadata encoder="FFmpeg (libx264 + aac)" -threads 2 -c:a copy -c:v copy -movflags +faststart "Determination.mp4"  
...
ffmpeg -i "Your Best Friend - Undertale Animation (Glitchtale #4) [3_kc80dPD5g].mp4" -map_metadata -1 -map_chapters -1 -map 0:0 -map 0:1 -id3v2_version 3 -metadata artist="Camila Cuevas" -metadata show="Glitch-Tale" -metadata title="Your Best Friend" -metadata track="4/5" -metadata genre="" -metadata language="English" -metadata encoder="FFmpeg (libx264 + aac)" -threads 2 -c:a copy -c:v copy -movflags +faststart "Your Best Friend.mp4"  
...
ffmpeg -i "Continue - Undertale Animation (Glitchtale #5 - Season 1 Finale) [2oZtRw1tHVQ].mp4" -map_metadata -1 -map_chapters -1 -map 0:0 -map 0:1 -id3v2_version 3 -metadata artist="Camila Cuevas" -metadata show="Glitch-Tale" -metadata title="Continue" -metadata track="5/5" -metadata genre="" -metadata language="English" -metadata encoder="FFmpeg (libx264 + aac)" -threads 2 -c:a copy -c:v copy -movflags +faststart "Continue.mp4"  
