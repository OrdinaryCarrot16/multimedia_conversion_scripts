...
ffmpeg -y -i "10 - I Am... All Of Me.mp3" -i cover_tmp.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="Crush 40" -metadata album="Driving Through Forever - Crush 40 Collection" -metadata title="I Am... All of Me" -metadata genre="Rock/Pop" -metadata language="English" -metadata copyright="© 2019, Crush 40" -metadata track="10/17" -c:1 png -disposition:1 attached_pic -c:a aac -ar 44100 -b:a 160k "I Am... All of Me.m4a"
ffmpeg -y -i "14 - Live & Learn.mp3" -i cover_tmp.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="Crush 40" -metadata album="Driving Through Forever - Crush 40 Collection" -metadata title="Live & Learn" -metadata genre="Rock/Pop" -metadata language="English" -metadata copyright="© 2019, Crush 40" -metadata track="14/17" -c:1 png -disposition:1 attached_pic -c:a aac -ar 44100 -b:a 160k "Live & Learn.m4a"
ffmpeg -y -i "15 - Open Your Heart.mp3" -i cover_tmp.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="Crush 40" -metadata album="Driving Through Forever - Crush 40 Collection" -metadata title="Open Your Heart" -metadata genre="Rock/Pop" -metadata language="English" -metadata copyright="© 2019, Crush 40" -metadata track="15/17" -c:1 png -disposition:1 attached_pic -c:a aac -ar 44100 -b:a 160k "Open Your Heart.m4a"
