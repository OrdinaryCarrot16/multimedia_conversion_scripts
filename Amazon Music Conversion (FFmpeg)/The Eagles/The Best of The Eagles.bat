...
ffmpeg -y -i "17 - Hotel California (2013 Remaster).mp3" -i cover_tmp.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="The Eagles" -metadata album="The Best of The Eagles" -metadata title="Hotel California" -metadata genre="Pop" -metadata copyright="© 2003, The Eagles" -metadata track="17/33" -c:1 png -disposition:1 attached_pic -c:a aac -ar 44100 -b:a 160k "Hotel California.m4a"
