...
ffmpeg -i "01 - Love I Need.mp3" -i cover_tmp.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="The Living Tombstone" -metadata title="Love I Need"  -metadata track="1/1" -metadata genre="Electronic/Pop" -metadata language="English" -metadata encoder="FFmpeg (aac)" -c:1 png -disposition:1 attached_pic -c:a aac -aac_coder fast -ar 44100 -af loudnorm=I=-16:TP=-2:LRA=8:linear=true:measured_I=-7.5:measured_LRA=2.5:measured_TP=0.8:measured_thresh=-17.7 -b:a 160k -movflags +faststart "Love I Need.m4a"
