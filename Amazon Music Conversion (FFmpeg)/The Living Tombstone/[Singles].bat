...
ffmpeg -y -i "01 - Love I Need.mp3" -i cover_tmp.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="The Living Tombstone" -metadata title="Love I Need" -metadata genre="Rock/Pop" -metadata language="English" -metadata copyright="© 2020, The Living Tombstone" -metadata track="1/1" -c:1 png -disposition:1 attached_pic -c:a liblamemp3 -ar 44100 -b:a 160k "Love I Need.mp3"

:: Move new files to said directory.
move "Love I Need.mp3" "%CD%\[Singles]"
