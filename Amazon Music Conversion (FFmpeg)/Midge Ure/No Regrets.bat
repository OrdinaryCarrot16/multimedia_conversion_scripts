...
ffmpeg -y -i "05 - The Man Who Sold the World.mp3" -i cover_tmp.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="Midge Ure" -metadata album="No Regrets" -metadata title="The Man Who Sold the World" -metadata genre="Pop" -metadata language="English" -metadata copyright="© 2003, Midge Ure" -metadata track="5/17" -c:1 png -disposition:1 attached_pic -c:a libmp3lame -ar 44100 -b:a 160k "The Man Who Sold the World.mp3"

:: Move new files to said directory.
move "The Man Who Sold the World.mp3" "%CD%\No Regrets [Converted]"
