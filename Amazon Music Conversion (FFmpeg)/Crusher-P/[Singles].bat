...
ffmpeg -i "01 - Again.mp3" -i cover_TMP.png -map_metadata -1 -map 0:0 -map 1:0 -id3v2_version 3 -metadata artist="Crusher-P" -metadata title="Again" -metadata genre="Techno" -metadata language="eng" -metadata date="2017-08-26" -c:1 png -disposition:1 attached_pic -af "loudnorm=I=-18:TP=-2:LRA=8:linear=true:measured_I=-9.2:measured_LRA=4:measured_TP=0.7:measured_thresh=-19.2" -c:a aac -aac_coder fast -ar 44100 -b:a 160k -movflags +faststart "Again.m4a"  
