...
# Transcode movie
ffmpeg -ss 00:00:02.000 -to 01:38:35.200 -i "The Croods.mkv" -i "blank_5.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "scale=1280:720:flags=bicubic [0:0]; volume=-5dB [0:2]; scale=1280:720:flags=bicubic [1:0]; [0:0][0:2] [1:0][1:1] concat=n=2:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata title="The Croods" -metadata date="2013-03-22" -r 24 -c:v libvpx -crf 12 -b:v 15M -c:a libopus -b:a 192k -ac 2 -ar 48000 "The Croods_TMP.mkv"
Move-Item -Path "The Croods_TMP.mkv" -Destination "The Croods (Converted)/The Croods.mkv"

# Transcode extras
ffmpeg -i "The Croodaceous Creatures of Croods.mkv" -map_metadata -1 -map_chapters -1 -metadata title="The Croodaceous Creatures of Croods" -metadata date="2013-03-22" -vf "scale=1280:720:flags=bicubic" -r 24 -c:v libvpx -crf 12 -b:v 15M -c:a libopus -b:a 192k -ac 2 -ar 48000 "The Croodaceous Creatures of Croods_TMP.mkv"
...
ffmpeg -i "Croods Cuts (Deleted Scenes).mkv" -map_metadata -1 -map_chapters -1 -metadata title="Croods Cuts (Deleted Scenes)" -metadata date="2013-03-22" -vf "scale=1280:720:flags=bicubic" -r 24 -c:v libvpx -crf 12 -b:v 15M -c:a libopus -b:a 192k -ac 2 -ar 48000 "Croods Cuts (Deleted Scenes)_TMP.mkv"
Move-Item -Path "Croods Cuts (Deleted Scenes)_TMP.mkv" "The Croods (Converted)/Extras/Croods Cuts (Deleted Scenes).mkv"

ffmpeg -i "Be An Artist.mkv" -map_metadata -1 -map_chapters -1 -metadata title="Be An Artist" -metadata date="2013-03-22" -vf "scale=1280:720:flags=bicubic" -r 24 -c:v libvpx -crf 12 -b:v 15M -c:a libopus -b:a 192k -ac 2 -ar 48000 "Be An Artist_TMP.mkv"
Move-Item -Path "Be An Artist_TMP.mkv" "The Croods (Converted)/Extras/Be An Artist.mkv"

ffmpeg -i "Belt's Cave Journal.mkv" -map_metadata -1 -map_chapters -1 -metadata title="Belt's Cave Journal" -metadata date="2013-03-22" -vf "scale=1280:720:flags=bicubic" -r 24 -c:v libvpx -crf 12 -b:v 15M -c:a libopus -b:a 192k -ac 2 -ar 48000 "Belt's Cave Journal_TMP.mkv"
