...
ffmpeg -i "Talk Show + American Idol.mkv" -map_metadata -1 -map_chapters -1 -metadata title="Talk Show + American Idol" -metadata date="2007-07-27" -vf "scale=1280:720:flags=bicubic" -r 24 -c:v libvpx -crf 12 -b:v 15M -c:a libopus -b:a 192k -ac 2 -ar 48000 "Talk Show + American Idol_TMP.mkv"
...
ffmpeg -i "Deleted Scenes.mkv" -map_metadata -1 -map_chapters -1 -metadata title="Deleted Scenes" -metadata date="2007-07-27" -vf "scale=1280:720:flags=bicubic" -r 24 -c:v libvpx -crf 12 -b:v 15M -c:a libopus -b:a 192k -ac 2 -ar 48000 "Deleted Scenes_TMP.mkv"
