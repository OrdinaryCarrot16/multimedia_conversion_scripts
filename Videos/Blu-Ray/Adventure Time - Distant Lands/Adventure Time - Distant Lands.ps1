...
ffmpeg -f lavfi -i "color=black:size=1280x720:rate=23.976" -f lavfi -i "anullsrc=sample_rate=48000:channel_layout=stereo" -t 3 -c:v libx264 -profile:v main -crf 16 "blank_3.mkv"
 
# Transcode series
ffmpeg -ss 00:00:01.650 -i "E01 - BMO.mkv" -to 00:45:04.550 -i "blank_3.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "scale=1280:720:flags=bicubic [0:0]; volume=-3dB [0:1]; [0:0][0:1] [1:0][1:1] concat=n=2:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -r 24 -c:v libvpx -crf 16 -b:v 15M -c:a libopus -b:a 160k -ac 2 -ar 48000 "E01 - BMO_TMP.mkv"
Move-Item -Path "E01 - BMO_TMP.mkv" -Destination "Adventure Time - Distant Lands [Converted]/E01 - BMO.mkv"

ffmpeg -ss 00:00:01.650 -i "E02 - Obsidian.mkv" -to 00:45:10.400 -i "blank_3.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "scale=1280:720:flags=bicubic [0:0]; volume=0dB [0:1]; [0:0][0:1] [1:0][1:1] concat=n=2:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -r 24 -c:v libvpx -crf 16 -b:v 15M -c:a libopus -b:a 160k -ac 2 -ar 48000 "E02 - Obsidian_TMP.mkv"
Move-Item -Path "E02 - Obsidian_TMP.mkv" -Destination "Adventure Time - Distant Lands [Converted]/E02 - Obsidian.mkv"

ffmpeg -ss 00:00:01.650 -i "E03 - Together Again.mkv" -to 00:46:24.700 -i "blank_3.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "scale=1280:720:flags=bicubic [0:0]; volume=0dB [0:1]; [0:0][0:1] [1:0][1:1] concat=n=2:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -r 24 -c:v libvpx -crf 16 -b:v 15M -c:a libopus -b:a 160k -ac 2 -ar 48000 "E03 - Together Again_TMP.mkv"
Move-Item -Path "E03 - Together Again_TMP.mkv" -Destination "Adventure Time - Distant Lands [Converted]/E03 - Together Again.mkv"

ffmpeg -ss 00:00:00.500 -i "E04 - Wizard City.mkv" -to 00:49:56.150 -i "blank_3.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "scale=1280:720:flags=bicubic [0:0]; volume=0dB [0:1]; [0:0][0:1] [1:0][1:1] concat=n=2:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -r 24 -c:v libvpx -crf 16 -b:v 15M -c:a libopus -b:a 160k -ac 2 -ar 48000 "E04 - Wizard City_TMP.mkv"
