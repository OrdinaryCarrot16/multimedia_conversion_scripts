...
# Transcode series
ffmpeg -ss 00:00:01.650 -i "E01 - BMO.mkv" -to 00:45:04.550 -i "blank_3.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "scale=1280:720:flags=bicubic [0:0]; volume=-3dB [0:1]; [0:0][0:1] [1:0][1:1] concat=n=2:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="Adventure Time: Distant Lands" -metadata title="B.M.O." -metadata date="2020-06-25" -r 24 -c:v libvpx -crf 16 -b:v 15M -c:a libopus -b:a 160k -ac 2 -ar 48000 "E01 - BMO_TMP.mkv"
