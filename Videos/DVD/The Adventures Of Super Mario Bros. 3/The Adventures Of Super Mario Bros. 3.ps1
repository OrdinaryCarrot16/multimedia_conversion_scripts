...
ffmpeg -ss 00:00:33.000 -to 00:05:53.900 -i "E17-E18 - Mush-Rumors + The Ugly Mermaid.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E17_episode_part_1_TMP.mkv"
ffmpeg -ss 00:05:55.650 -to 00:11:42.900 -i "E17-E18 - Mush-Rumors + The Ugly Mermaid.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E17_episode_part_2_TMP.mkv"
ffmpeg -ss 00:22:54.550 -to 00:23:25.500 -i "E17-E18 - Mush-Rumors + The Ugly Mermaid.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E17+E18_credits_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E17_episode_part_1_TMP.mkv" -i "blank_1_TMP.mkv" -i "E17_episode_part_2_TMP.mkv" -i "blank_1_TMP.mkv" -i "E17+E18_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [6:0]; volume=5dB [6:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [7:0]; anull [7:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] [6:0][6:1] [7:0][7:1] concat=n=8:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="Mush-Rumors" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E17 - Mush-Rumors_TMP.mkv"
Move-Item -Path "E17 - Mush-Rumors_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E17 - Mush-Rumors.mkv"
Remove-Item "E17_episode_part_1_TMP.mkv"
Remove-Item "E17_episode_part_2_TMP.mkv"

ffmpeg -ss 00:11:44.900 -to 00:22:52.750 -i "E17-E18 - Mush-Rumors + The Ugly Mermaid.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E18_episode_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E18_episode_TMP.mkv" -i "blank_1_TMP.mkv" -i "E17+E18_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] concat=n=6:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="The Ugly Mermaid" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E18 - The Ugly Mermaid_TMP.mkv"
Move-Item -Path "E18 - The Ugly Mermaid_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E18 - The Ugly Mermaid.mkv"
Remove-Item "E18_episode_TMP.mkv"
Remove-Item "E17+E18_credits_TMP.mkv"

ffmpeg -ss 00:00:32.850 -to 00:06:46.900 -i "E19-E20 - Crimes 'R Us + Life's Ruff.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E19_episode_part_1_TMP.mkv"
ffmpeg -ss 00:06:48.800 -to 00:11:42.700 -i "E19-E20 - Crimes 'R Us + Life's Ruff.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E19_episode_part_2_TMP.mkv"
ffmpeg -ss 00:22:54.850 -to 00:23:25.850 -i "E19-E20 - Crimes 'R Us + Life's Ruff.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E19+E20_credits_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E19_episode_part_1_TMP.mkv" -i "blank_1_TMP.mkv" -i "E19_episode_part_2_TMP.mkv" -i "blank_1_TMP.mkv" -i "E19+E20_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [6:0]; volume=5dB [6:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [7:0]; anull [7:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] [6:0][6:1] [7:0][7:1] concat=n=8:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="Crimes 'R Us" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E19 - Crimes 'R Us_TMP.mkv"
Move-Item -Path "E19 - Crimes 'R Us_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E19 - Crimes 'R Us.mkv"
Remove-Item "E19_episode_part_1_TMP.mkv"
Remove-Item "E19_episode_part_2_TMP.mkv"

ffmpeg -ss 00:11:44.950 -to 00:22:53.100 -i "E19-E20 - Crimes 'R Us + Life's Ruff.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E20_episode_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E20_episode_TMP.mkv" -i "blank_1_TMP.mkv" -i "E19+E20_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] concat=n=6:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="Life's Ruff" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E20 - Life's Ruff_TMP.mkv"
Move-Item -Path "E20 - Life's Ruff_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E20 - Life's Ruff.mkv"
Remove-Item "E20_episode_TMP.mkv"
Remove-Item "E19+E20_credits_TMP.mkv"

ffmpeg -ss 00:00:32.900 -to 00:05:45.950 -i "E21-E22 - Up Up And A Koopa + Seven Continents For Seven Koopas.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E21_episode_part_1_TMP.mkv"
ffmpeg -ss 00:05:47.750 -to 00:11:42.900 -i "E21-E22 - Up Up And A Koopa + Seven Continents For Seven Koopas.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E21_episode_part_2_TMP.mkv"
ffmpeg -ss 00:22:54.800 -to 00:23:25.750 -i "E21-E22 - Up Up And A Koopa + Seven Continents For Seven Koopas.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E21+E22_credits_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E21_episode_part_1_TMP.mkv" -i "blank_1_TMP.mkv" -i "E21_episode_part_2_TMP.mkv" -i "blank_1_TMP.mkv" -i "E21+E22_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [6:0]; volume=5dB [6:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [7:0]; anull [7:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] [6:0][6:1] [7:0][7:1] concat=n=8:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="Up Up And A Koopa" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E21 - Up Up And A Koopa_TMP.mkv"
Move-Item -Path "E21 - Up Up And A Koopa_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E21 - Up Up And A Koopa.mkv"
Remove-Item "E21_episode_part_1_TMP.mkv"
Remove-Item "E21_episode_part_2_TMP.mkv"

ffmpeg -ss 00:11:44.950 -to 00:22:52.900 -i "E21-E22 - Up Up And A Koopa + Seven Continents For Seven Koopas.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E22_episode_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E22_episode_TMP.mkv" -i "blank_1_TMP.mkv" -i "E21+E22_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] concat=n=6:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="Seven Continents For Seven Koopas" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E22 - Seven Continents For Seven Koopas_TMP.mkv"
Move-Item -Path "E22 - Seven Continents For Seven Koopas_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E22 - Seven Continents For Seven Koopas.mkv"
Remove-Item "E22_episode_TMP.mkv"
Remove-Item "E21+E22_credits_TMP.mkv"

ffmpeg -ss 00:00:33.000 -to 00:07:03.650 -i "E23-E24 - True Colors + Recycled Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E23_episode_part_1_TMP.mkv"
ffmpeg -ss 00:07:05.450 -to 00:11:42.450 -i "E23-E24 - True Colors + Recycled Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E23_episode_part_2_TMP.mkv"
ffmpeg -ss 00:22:54.100 -to 00:23:25.050 -i "E23-E24 - True Colors + Recycled Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E23+E24_credits_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E23_episode_part_1_TMP.mkv" -i "blank_1_TMP.mkv" -i "E23_episode_part_2_TMP.mkv" -i "blank_1_TMP.mkv" -i "E23+E24_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [6:0]; volume=5dB [6:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [7:0]; anull [7:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] [6:0][6:1] [7:0][7:1] concat=n=8:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="True Colors" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E23 - True Colors_TMP.mkv"
Move-Item -Path "E23 - True Colors_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E23 - True Colors.mkv"
Remove-Item "E23_episode_part_1_TMP.mkv"
Remove-Item "E23_episode_part_2_TMP.mkv"

ffmpeg -ss 00:11:44.400 -to 00:22:52.250 -i "E23-E24 - True Colors + Recycled Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E24_episode_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E24_episode_TMP.mkv" -i "blank_1_TMP.mkv" -i "E23+E24_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] concat=n=6:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="Recycled Koopa" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E24 - Recycled Koopa_TMP.mkv"
Move-Item -Path "E24 - Recycled Koopa_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E24 - Recycled Koopa.mkv"
Remove-Item "E24_episode_TMP.mkv"
Remove-Item "E23+E24_credits_TMP.mkv"

ffmpeg -ss 00:00:32.900 -to 00:06:12.550 -i "E25-E26 - The Venice Menace + Super Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E25_episode_part_1_TMP.mkv"
ffmpeg -ss 00:06:14.750 -to 00:11:43.250 -i "E25-E26 - The Venice Menace + Super Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E25_episode_part_2_TMP.mkv"
ffmpeg -ss 00:22:55.850 -to 00:23:26.850 -i "E25-E26 - The Venice Menace + Super Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E25+E26_credits_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E25_episode_part_1_TMP.mkv" -i "blank_1_TMP.mkv" -i "E25_episode_part_2_TMP.mkv" -i "blank_1_TMP.mkv" -i "E25+E26_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=5dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [6:0]; volume=5dB [6:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [7:0]; anull [7:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] [6:0][6:1] [7:0][7:1] concat=n=8:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="The Venice Menace" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E25 - The Venice Menace_TMP.mkv"
Move-Item -Path "E25 - The Venice Menace_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E25 - The Venice Menace.mkv"
Remove-Item "E25_episode_part_1_TMP.mkv"
Remove-Item "E25_episode_part_2_TMP.mkv"

ffmpeg -ss 00:11:45.900 -to 00:22:54.050 -i "E25-E26 - The Venice Menace + Super Koopa.mkv" -map_metadata -1 -map_chapters -1 -avoid_negative_ts make_zero -c:v ffv1 -c:a flac "E26_episode_TMP.mkv"

ffmpeg -i "intro_TMP.mkv" -i "blank_1_TMP.mkv" -i "E26_episode_TMP.mkv" -i "blank_1_TMP.mkv" -i "E25+E26_credits_TMP.mkv" -i "blank_3_TMP.mkv" -map_metadata -1 -map_chapters -1 -filter_complex "bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [0:0]; volume=5dB [0:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [1:0]; anull [1:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [2:0]; volume=10dB [2:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [3:0]; anull [3:1]; bwdif=deint=all:mode=send_frame,hqdn3d=luma_spatial=4:chroma_spatial=2,scale=640:480:flags=bicubic,setsar=sar=1/1 [4:0]; volume=5dB [4:1]; scale=640:480:flags=bicubic,setsar=sar=1/1 [5:0]; anull [5:1]; [0:0][0:1] [1:0][1:1] [2:0][2:1] [3:0][3:1] [4:0][4:1] [5:0][5:1] concat=n=6:v=1:a=1 [v][a]" -map '[v]' -map '[a]' -metadata show="The Adventures Of Super Mario Bros. 3" -metadata title="Super Koopa" -metadata date="1990-09-08" -r 30 -c:v libvpx -crf 16 -b:v 10M -c:a libopus -b:a 192k -ac 2 -ar 48000 "E26 - Super Koopa_TMP.mkv"
Move-Item -Path "E26 - Super Koopa_TMP.mkv" -Destination "The Adventures Of Super Mario Bros. 3 (Converted)/E26 - Super Koopa.mkv"
Remove-Item "E26_episode_TMP.mkv"
Remove-Item "E25+E26_credits_TMP.mkv"
